...
public class AccountManager {
    ...
    public AccountManager() {
        ...
        accounts.add(new Enterprise(new User("Hakan","Pektaþ","hakan@pektas","123","ogrenci",21)));
        accounts.add(new Individual(new User("Murat","Kaya","murat@kaya","123","ogrenci",17)));
        accounts.add(new Individual(new User("Coþkun","Kral","coskun@kral","123","ogrenci",23)));
    }
